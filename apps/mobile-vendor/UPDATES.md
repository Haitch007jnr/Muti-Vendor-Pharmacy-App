# Pharmacy Vendor App - In-App Updates

## Overview

This app supports Over-The-Air (OTA) updates using Expo Updates. Vendors receive automatic notifications when new updates are available and can install them without visiting the app store.
...
2. **Notification**: If an update is available, vendors see an alert
3. **User Choice**: Vendors can choose to update now or later
