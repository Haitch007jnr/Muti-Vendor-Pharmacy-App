...
import { TransactionType, TransactionCategory } from '../entities/account.entity';
...
export class CreateTransactionDto {
  ...
  @ApiProperty({ description: 'Transaction category', enum: TransactionCategory, required: false })
