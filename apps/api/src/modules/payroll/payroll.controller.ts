...
export class PayrollController {
  ...
  async create(@Body() createPayrollDto: CreatePayrollDto, @Request() req: any) {
  ...
  @ApiQuery({ name: 'status', required: false, description: 'Filter by status', enum: PayrollStatus })
  ...
  @ApiResponse({ status: 400, description: 'Bad request' })
  async addPayslip(@Param('id') id: string, @Body() generatePayslipDto: GeneratePayslipDto) {
