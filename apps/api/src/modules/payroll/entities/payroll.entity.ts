...
export class Payroll {
  ...
  @Column({ type: 'varchar', length: 100, unique: true, name: 'payroll_number' })
  ...
  @Column({ type: 'decimal', precision: 15, scale: 2, name: 'total_deductions', default: 0 })
...
export class Payslip {
  ...
  @Column({ type: 'decimal', precision: 10, scale: 2, name: 'health_insurance', default: 0 })
  healthInsurance: number;

  @ApiProperty({ description: 'Other deductions', required: false })
  @Column({ type: 'decimal', precision: 10, scale: 2, name: 'other_deductions', default: 0 })
  otherDeductions: number;

  @ApiProperty({ description: 'Total deductions' })
  @Column({ type: 'decimal', precision: 10, scale: 2, name: 'total_deductions', default: 0 })
  totalDeductions: number;
  ...
  @ManyToOne(() => Payroll, (payroll) => payroll.payslips, { onDelete: 'CASCADE' })
