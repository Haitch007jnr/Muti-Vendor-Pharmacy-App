...
export class PurchasesController {
  ...
  async getTotalPurchases(
    ...
    const total = await this.purchasesService.getTotalPurchases(vendorId, startDate, endDate);
    return { total };
  }
  ...
  async getAveragePurchasePrice(
    ...
    const avgPrice = await this.purchasesService.getAveragePurchasePrice(productId, vendorId);
