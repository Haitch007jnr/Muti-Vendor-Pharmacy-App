...
export class CreateExpenseDto {
  ...
  @ApiProperty({ description: 'Expense subcategory', required: false, example: 'Stationery' })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  subcategory?: string;

  @ApiProperty({ description: 'Expense description', required: false, example: 'Purchase of office supplies' })
  @IsOptional()
  @IsString()
  description?: string;

  @ApiProperty({ description: 'Expense amount', example: 15000.50 })
  @IsNumber()
  @Min(0)
  amount: number;
