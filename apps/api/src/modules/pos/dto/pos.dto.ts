...
export class CreatePosSessionDto {
  ...
  @ApiProperty({ description: "Opening balance", example: 1000.0 })
  @IsNumber()
  @Min(0)
...
export class CreatePosTransactionDto {
  ...
  @ApiProperty({ description: "Amount paid", example: 300.0 })
  @IsNumber()
  @Min(0)
  amountPaid: number;
...
export class ClosePosSessionDto {
  @ApiProperty({ description: "Closing balance", example: 1500.0 })
  @IsNumber()
  @Min(0)
