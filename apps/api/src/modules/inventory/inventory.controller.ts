...
export class InventoryController {
  ...
  @ApiResponse({ status: 200, description: 'Expiring soon items retrieved successfully' })
  ...
  @ApiResponse({ status: 400, description: 'Bad request' })
  async adjustInventory(@Body() createAdjustmentDto: CreateAdjustmentDto, @Request() req: any) {
    return this.inventoryService.adjustInventory(createAdjustmentDto, req.user.id);
  }
  ...
  async reserveStock(
    ...
    return this.inventoryService.reserveStock(body.productId, body.vendorId, body.quantity);
  }
  ...
  async releaseReservedStock(
    ...
    return this.inventoryService.releaseReservedStock(body.productId, body.vendorId, body.quantity);
  }
