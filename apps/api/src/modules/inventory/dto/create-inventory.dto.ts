...
import { IsUUID, IsInt, IsOptional, IsString, IsDate, Min } from 'class-validator';
...
export class CreateInventoryDto {
  ...
  @ApiProperty({ description: 'Quantity reserved', default: 0, required: false })
  @IsInt()
  @Min(0)
  @IsOptional()
  ...
  @ApiProperty({ description: 'Reorder quantity', default: 50, required: false })
  @IsInt()
  @Min(1)
  @IsOptional()
