# Pharmacy Delivery App - In-App Updates

## Overview

This app supports Over-The-Air (OTA) updates using Expo Updates. Delivery personnel receive automatic notifications when new updates are available and can install them without visiting the app store.
...
2. **Notification**: If an update is available, delivery personnel see an alert
